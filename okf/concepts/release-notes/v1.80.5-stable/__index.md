...
description: "Deploy this version Key Highlights Gemini 3 Day 0 support for Gemini 3 models with thought signatures Prompt Management Full prompt versioning support with UI for editing, testi..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.80.5-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.80.5-stable/index.md"
...
This concept mirrors [`release_notes/v1.80.5-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.80.5-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
