...
description: "Deploy this version Key Highlights Agent Gateway (A2A) Invoke agents through the AI Gateway with request/response logging and access controls Guardrails API v2 Generic Guardrail..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.80.8-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.80.8-stable/index.md"
...
This concept mirrors [`release_notes/v1.80.8-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.80.8-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
