...
description: "Deploy this version v1.88.2 is a patch release on top of v1.88.1 . It backports an already merged set: the database resilience fixes, passthrough corrections, the /v1/model/info..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.88.2/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.88.2/index.md"
...
This concept mirrors [`release_notes/v1.88.2/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.88.2/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
