...
description: "v1.61.20 stable These are the changes since v1.61.13 stable . This release is primarily focused on: LLM Translation improvements (claude 3 7 sonnet + 'thinking'/'reasoning conte..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.61.20-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.61.20-stable/index.md"
...
This concept mirrors [`release_notes/v1.61.20-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.61.20-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
