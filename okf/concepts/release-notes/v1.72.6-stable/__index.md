...
description: "Deploy this version TLDR Why Upgrade Codex mini on Claude Code: You can now use codex mini (OpenAI’s code assistant model) via Claude Code. MCP Permissions Management: Manage pe..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.72.6-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.72.6-stable/index.md"
...
This concept mirrors [`release_notes/v1.72.6-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.72.6-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
