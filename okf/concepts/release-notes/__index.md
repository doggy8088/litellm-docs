...
type: "Release note"
title: "Release Notes"
description: "Release Notes LiteLLM ships new releases regularly with new provider support, performance improvements, and enterprise features. Use the sidebar to browse all releases. Latest R..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/index.md"
...
This concept mirrors [`release_notes/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
