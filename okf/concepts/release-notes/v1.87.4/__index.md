...
description: "Deploy this version v1.87.4 is a patch release on top of v1.87.3 . It backports guardrail correctness fixes (a single pre call hook for model level guardrails, no DB re init on..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.87.4/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.87.4/index.md"
...
This concept mirrors [`release_notes/v1.87.4/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.87.4/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
