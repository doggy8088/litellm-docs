...
description: "Key Highlights SCIM Integration : Enables identity providers (Okta, Azure AD, OneLogin, etc.) to automate user and team (group) provisioning, updates, and deprovisioning Team an..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.67.0-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.67.0-stable/index.md"
...
This concept mirrors [`release_notes/v1.67.0-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.67.0-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
