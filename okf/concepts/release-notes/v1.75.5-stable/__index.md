...
description: "Deploy this version Key Highlights Redis Latency Improvements Reduces P99 latency by 50% with Redis enabled. Responses API Session Management Support for managing responses API..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.75.5-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.75.5-stable/index.md"
...
This concept mirrors [`release_notes/v1.75.5-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.75.5-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
