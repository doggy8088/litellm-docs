...
description: "Deploy this version Key Highlights Container API Support End to end OpenAI Container API support with proxy integration, logging, and cost tracking FAL AI Image Generation Nativ..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.79.1-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.79.1-stable/index.md"
...
This concept mirrors [`release_notes/v1.79.1-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.79.1-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
