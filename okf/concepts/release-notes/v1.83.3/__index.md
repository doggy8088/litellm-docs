...
description: "Deploy this version Key Highlights MCP Toolsets — Create curated tool subsets from one or more MCP servers with scoped permissions, and manage them from the UI or API Skills Mar..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.83.3/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.83.3/index.md"
...
This concept mirrors [`release_notes/v1.83.3/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.83.3/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
