...
description: "Deploy this version Key Highlights Agent (A2A) Gateway with Cost Tracking Track agent costs per query, per token pricing, and view agent usage in the dashboard 2 New Agent Provi..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.80.10-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.80.10-stable/index.md"
...
This concept mirrors [`release_notes/v1.80.10-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.80.10-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
