...
type: "Release note"
title: "v1.59.0"
description: "v1.59.0 :::info Get a 7 day free trial for LiteLLM Enterprise here. no call needed ::: UI Improvements [Opt In] Admin UI view messages / responses You can now view messages and..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.59.0/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.59.0/index.md"
...
This concept mirrors [`release_notes/v1.59.0/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.59.0/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
