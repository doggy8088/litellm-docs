...
description: "Deploy this version v1.84.3 is a Dockerfile only re cut of v1.84.2 ; the application code is identical. It restores npm to the Dockerfile.non root builder stage so the litellm n..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.84.3/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.84.3/index.md"
...
This concept mirrors [`release_notes/v1.84.3/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.84.3/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
