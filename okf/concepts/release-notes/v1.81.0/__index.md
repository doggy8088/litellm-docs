...
description: "Deploy this version Key Highlights Claude Code Support for using web search across Bedrock, Vertex AI, and all LiteLLM providers Major Change 50MB limit on image URL downloads t..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.81.0/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.81.0/index.md"
...
This concept mirrors [`release_notes/v1.81.0/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.81.0/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
