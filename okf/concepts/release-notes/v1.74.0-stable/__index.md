...
description: "Deploy this version Key Highlights MCP Gateway Namespace Servers Clients connecting to LiteLLM can now specify which MCP servers to use. Key/Team Based Logging on UI Proxy Admin..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.74.0-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.74.0-stable/index.md"
...
This concept mirrors [`release_notes/v1.74.0-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.74.0-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
