...
description: "Deploy this version Key Highlights Gemini 3 Flash Preview Day 0 support for Google's Gemini 3 Flash Preview with reasoning capabilities Stability AI Image Generation New provide..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.80.11-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.80.11-stable/index.md"
...
This concept mirrors [`release_notes/v1.80.11-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.80.11-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
