...
description: "v1.65.0 stable is live now. Here are the key highlights of this release: MCP Support : Support for adding and using MCP servers on the LiteLLM proxy. UI view total usage after 1..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.65.0-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.65.0-stable/index.md"
...
This concept mirrors [`release_notes/v1.65.0-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.65.0-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
