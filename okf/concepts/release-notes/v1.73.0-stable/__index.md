...
description: ":::warning Known Issues The non root docker image has a known issue around the UI not loading. If you use the non root docker image we recommend waiting before upgrading to this..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.73.0-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.73.0-stable/index.md"
...
This concept mirrors [`release_notes/v1.73.0-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.73.0-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
