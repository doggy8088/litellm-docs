...
description: "Deploy this version Key Highlights LiteLLM v1.70.1 stable is live now. Here are the key highlights of this release: Gemini Realtime API : You can now call Gemini's Live API via..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.70.1-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.70.1-stable/index.md"
...
This concept mirrors [`release_notes/v1.70.1-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.70.1-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
