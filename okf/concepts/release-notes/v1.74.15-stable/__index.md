...
description: "Deploy this version Key Highlights User Agent Activity Tracking Track how much usage each coding tool gets. Prompt Management Use Git Ops style prompt management with prompt tem..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.74.15-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.74.15-stable/index.md"
...
This concept mirrors [`release_notes/v1.74.15-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.74.15-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
