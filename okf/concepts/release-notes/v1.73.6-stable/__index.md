...
description: "Deploy this version Key Highlights Claude on gemini cli This release brings support for using gemini cli with LiteLLM. You can use claude sonnet 4, gemini 2.5 flash (Vertex AI &..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.73.6-stable/index.md"
tags: ["release-notes","release-note"]
source_path: "release_notes/v1.73.6-stable/index.md"
...
This concept mirrors [`release_notes/v1.73.6-stable/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/release_notes/v1.73.6-stable/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
