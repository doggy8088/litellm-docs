...
description: "Helicone Tutorial Helicone is an open source observability platform that proxies your OpenAI traffic and provides you key insights into your spend, latency and usage. Use Helico..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/src/pages/observability/helicone_integration.md"
tags: ["pages","standalone-page"]
source_path: "src/pages/observability/helicone_integration.md"
source_area: "pages"
...
This concept mirrors [`src/pages/observability/helicone_integration.md`](https://github.com/BerriAI/litellm-docs/blob/main/src/pages/observability/helicone_integration.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
