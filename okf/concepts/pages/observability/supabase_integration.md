...
description: "Supabase Tutorial Supabase is an open source Firebase alternative. Start your project with a Postgres database, Authentication, instant APIs, Edge Functions, Realtime subscripti..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/src/pages/observability/supabase_integration.md"
tags: ["pages","standalone-page"]
source_path: "src/pages/observability/supabase_integration.md"
source_area: "pages"
...
This concept mirrors [`src/pages/observability/supabase_integration.md`](https://github.com/BerriAI/litellm-docs/blob/main/src/pages/observability/supabase_integration.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
