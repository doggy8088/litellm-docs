...
title: "Input"
description: "Completion Function completion() The Input params are exactly the same as the OpenAI Create chat completion , and let you call Azure OpenAI, Anthropic, Cohere, Replicate, OpenRo..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/src/pages/completion/input.md"
tags: ["pages","standalone-page"]
source_path: "src/pages/completion/input.md"
source_area: "pages"
...
This concept mirrors [`src/pages/completion/input.md`](https://github.com/BerriAI/litellm-docs/blob/main/src/pages/completion/input.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
