...
title: "A2a Cost Tracking"
description: "A2A Agent Cost Tracking LiteLLM supports adding custom cost tracking for A2A agents. You can configure: Flat cost per query A fixed cost charged for each agent request Cost by i..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/a2a_cost_tracking.md"
tags: ["docs","documentation-page"]
source_path: "docs/a2a_cost_tracking.md"
source_area: "docs"
...
This concept mirrors [`docs/a2a_cost_tracking.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/a2a_cost_tracking.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
