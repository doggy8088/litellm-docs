...
title: "Mcp Control"
description: "MCP Permission Management Control which MCP servers and tools can be accessed by specific keys, teams, or organizations in LiteLLM. When a client attempts to list or call tools,..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_control.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_control.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_control.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_control.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
