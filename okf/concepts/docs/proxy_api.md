...
title: "Proxy Api"
description: "🔑 LiteLLM Keys (Access Claude 2, Llama2 70b, etc.) Use this if you're trying to add support for new LLMs and need access for testing. We provide a free $10 community key for te..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy_api.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy_api.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy_api.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy_api.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
