...
title: "Max Callbacks"
description: "MAX CALLBACKS Limit Error Message What This Means LiteLLM limits the number of callbacks that can be registered to prevent performance degradation. Each callback runs on every L..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/troubleshoot/max_callbacks.md"
tags: ["docs","documentation-page"]
source_path: "docs/troubleshoot/max_callbacks.md"
source_area: "docs"
...
This concept mirrors [`docs/troubleshoot/max_callbacks.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/troubleshoot/max_callbacks.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
