...
description: "Latency Overhead Troubleshooting Use this guide when you see unexpected latency overhead between LiteLLM proxy and the LLM provider. The Invisible Latency Gap LiteLLM measures l..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/troubleshoot/latency_overhead.md"
tags: ["docs","documentation-page"]
source_path: "docs/troubleshoot/latency_overhead.md"
source_area: "docs"
...
This concept mirrors [`docs/troubleshoot/latency_overhead.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/troubleshoot/latency_overhead.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
