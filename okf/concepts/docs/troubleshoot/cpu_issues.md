...
title: "Cpu Issues"
description: "CPU Issue Classification & Reproduction 1. Classify the CPU Issue Select the options that best describes the CPU behavior observed. [ ] CPU scales with traffic (RPS driven) [ ]..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/troubleshoot/cpu_issues.md"
tags: ["docs","documentation-page"]
source_path: "docs/troubleshoot/cpu_issues.md"
source_area: "docs"
...
This concept mirrors [`docs/troubleshoot/cpu_issues.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/troubleshoot/cpu_issues.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
