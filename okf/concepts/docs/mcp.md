...
title: "Mcp"
description: "MCP Overview LiteLLM Proxy provides an MCP Gateway that allows you to use a fixed endpoint for all MCP tools and control MCP access by Key, Team. LiteLLM MCP Architecture: Use M..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp.md"
...
This concept mirrors [`docs/mcp.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
