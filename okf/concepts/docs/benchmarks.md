...
title: "Benchmarks"
description: "Benchmarks Benchmarks for LiteLLM Gateway (Proxy Server) tested against a fake OpenAI endpoint. LiteLLM Gateway has 8ms P95 latency at 1k RPS (See benchmarks here) Machine Spec..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/benchmarks.md"
...
This concept mirrors [`docs/benchmarks.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/benchmarks.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
