...
title: "Mcp Obo Auth"
description: "MCP OBO Auth OAuth 2.0 On Behalf Of (OBO) auth lets LiteLLM exchange a user's incoming bearer token for a scoped token that is valid for a specific MCP server. Use OBO when: You..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_obo_auth.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_obo_auth.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_obo_auth.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_obo_auth.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
