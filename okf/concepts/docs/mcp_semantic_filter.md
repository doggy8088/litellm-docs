...
title: "Mcp Semantic Filter"
description: "MCP Semantic Tool Filter Automatically filter MCP tools by semantic relevance. When you have many MCP tools registered, LiteLLM semantically matches the user's query against too..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_semantic_filter.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_semantic_filter.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_semantic_filter.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_semantic_filter.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
