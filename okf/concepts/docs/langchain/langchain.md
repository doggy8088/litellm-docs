...
title: "Langchain"
description: "Using ChatLiteLLM() Langchain Pre Requisites Quick Start Use Langchain ChatLiteLLM with MLflow MLflow provides open source observability solution for ChatLiteLLM. To enable the..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/langchain/langchain.md"
tags: ["docs","documentation-page"]
source_path: "docs/langchain/langchain.md"
source_area: "docs"
...
This concept mirrors [`docs/langchain/langchain.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/langchain/langchain.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
