...
title: "Image Edits"
description: "/images/edits LiteLLM provides image editing functionality that maps to OpenAI's /images/edits API endpoint. Now supports both single and multiple image editing. | Feature | Sup..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/image_edits.md"
tags: ["docs","documentation-page"]
source_path: "docs/image_edits.md"
source_area: "docs"
...
This concept mirrors [`docs/image_edits.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/image_edits.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
