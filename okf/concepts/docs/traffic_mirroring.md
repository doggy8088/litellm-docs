...
description: "A/B Testing Traffic Mirroring Traffic mirroring allows you to \"mimic\" production traffic to a secondary (silent) model for evaluation purposes. The silent model's response is ga..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/traffic_mirroring.md"
tags: ["docs","documentation-page"]
source_path: "docs/traffic_mirroring.md"
source_area: "docs"
...
This concept mirrors [`docs/traffic_mirroring.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/traffic_mirroring.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
