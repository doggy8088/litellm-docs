...
title: "Mcp Oauth"
description: "MCP OAuth LiteLLM supports two OAuth 2.0 flows for MCP servers. Every auth type: oauth2 server in config.yaml must declare which one it uses via oauth2 flow : | Flow | oauth2 fl..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_oauth.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_oauth.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_oauth.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_oauth.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
