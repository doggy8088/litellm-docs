...
title: "Mcp Usage"
description: "Using your MCP This document covers how to use LiteLLM as an MCP Gateway. You can see how to use it with Responses API, Cursor IDE, and OpenAI SDK. Use on LiteLLM UI Follow this..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_usage.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_usage.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_usage.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_usage.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
