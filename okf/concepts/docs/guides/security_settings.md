...
description: "SSL, HTTP Proxy Security Settings If you're in an environment using an older TTS bundle, with an older encryption, follow this guide. By default LiteLLM uses the certifi CA bund..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/guides/security_settings.md"
tags: ["docs","documentation-page"]
source_path: "docs/guides/security_settings.md"
source_area: "docs"
...
This concept mirrors [`docs/guides/security_settings.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/guides/security_settings.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
