...
title: "Rag Query"
description: "/rag/query RAG Query endpoint: Search Vector Store → (Rerank) → LLM Completion | Feature | Supported | | | | | Logging | Yes | | Streaming | Yes | | Reranking | Yes (optional) |..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/rag_query.md"
tags: ["docs","documentation-page"]
source_path: "docs/rag_query.md"
source_area: "docs"
...
This concept mirrors [`docs/rag_query.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/rag_query.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
