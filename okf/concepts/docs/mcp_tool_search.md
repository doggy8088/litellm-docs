...
description: "MCP Tool Search Swap the full MCP catalog for a fixed pair of virtual tools ( mcp tool search , mcp tool call ) so a key with hundreds of tools available only ever exposes two o..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_tool_search.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_tool_search.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_tool_search.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_tool_search.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
