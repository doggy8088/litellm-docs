...
title: "Learn LiteLLM"
description: "LiteLLM gives you one OpenAI compatible interface for 100+ LLM providers. Start with the path that matches your setup. Start Here Pick one path first. Common Tasks Jump to a spe..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/learn/index.md"
...
This concept mirrors [`docs/learn/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/learn/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
