...
description: "MCP Server Submissions LiteLLM supports a submission and approval workflow for MCP servers. Team members can submit MCP servers for admin review — the server is held in a pendin..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_server_submissions.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_server_submissions.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_server_submissions.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_server_submissions.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
