...
description: "[Beta] Routing based on request metadata Create routing rules based on request metadata. Setup Add the following to your litellm proxy config yaml file. 1. Create a tag On the L..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/tag_management.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/tag_management.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/tag_management.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/tag_management.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
