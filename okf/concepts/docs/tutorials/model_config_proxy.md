...
title: "Model Config Proxy"
description: "Customize Prompt Templates on OpenAI Compatible server You will learn: How to set a custom prompt template on our OpenAI compatible server. How? We will modify the prompt templa..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/model_config_proxy.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/model_config_proxy.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/model_config_proxy.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/model_config_proxy.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
