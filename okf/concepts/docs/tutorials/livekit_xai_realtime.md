...
title: "Livekit Xai Realtime"
description: "LiveKit xAI Realtime Voice Agent Use LiveKit's xAI Grok Voice Agent plugin with LiteLLM Proxy to build low latency voice AI agents. The LiveKit Agents framework provides tools f..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/livekit_xai_realtime.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/livekit_xai_realtime.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/livekit_xai_realtime.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/livekit_xai_realtime.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
