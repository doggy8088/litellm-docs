...
description: "Auto Inject Prompt Caching Checkpoints Reduce costs by up to 90% by using LiteLLM to auto inject prompt caching checkpoints. Supported Providers ( cache control marker): Anthrop..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/prompt_caching.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/prompt_caching.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/prompt_caching.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/prompt_caching.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
