...
title: "Litellm Proxy Aporia"
description: "Aporia Guardrails with LiteLLM Gateway In this tutorial we will use LiteLLM AI Gateway with Aporia to detect PII in requests and profanity in responses 1. Setup guardrails on Ap..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/litellm_proxy_aporia.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/litellm_proxy_aporia.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/litellm_proxy_aporia.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/litellm_proxy_aporia.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
