...
description: "Google GenAI SDK with LiteLLM Use Google's official GenAI SDK (JavaScript/TypeScript and Python) with any LLM provider through LiteLLM Proxy. The Google GenAI SDK ( @google/gena..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/google_genai_sdk.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/google_genai_sdk.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/google_genai_sdk.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/google_genai_sdk.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
