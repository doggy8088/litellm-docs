...
title: "File Search Responses Api"
description: "File Search in the Responses API LiteLLM now supports file search in the Responses API across both: providers that support it natively (like OpenAI / Azure), and providers that..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/file_search_responses_api.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/file_search_responses_api.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/file_search_responses_api.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/file_search_responses_api.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
