...
title: "Claude Code Websearch"
description: "Claude Code WebSearch Across All Providers Enable Claude Code's web search tool to work with any provider (Bedrock, Azure, Vertex, etc.). LiteLLM automatically intercepts web se..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_websearch.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/claude_code_websearch.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/claude_code_websearch.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_websearch.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
