...
title: "Claude Code Beta Headers"
description: "Claude Code Managing Anthropic Beta Headers When using Claude Code with LiteLLM and non Anthropic providers (Bedrock, Azure AI, Vertex AI), you need to ensure that only supporte..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_beta_headers.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/claude_code_beta_headers.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/claude_code_beta_headers.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_beta_headers.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
