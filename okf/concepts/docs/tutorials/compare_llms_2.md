...
title: "Compare Llms 2"
description: "Comparing LLMs on a Test Set using LiteLLM LiteLLM allows you to use any LLM as a drop in replacement for gpt 3.5 turbo This notebook walks through how you can compare GPT 4 vs..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/compare_llms_2.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/compare_llms_2.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/compare_llms_2.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/compare_llms_2.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
