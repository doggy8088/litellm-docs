...
description: "Create your first LLM playground Create a playground to evaluate multiple LLM Providers in less than 10 minutes . If you want to see this in prod, check out our website. What wi..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/first_playground.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/first_playground.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/first_playground.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/first_playground.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
