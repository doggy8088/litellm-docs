...
title: "Gemini Realtime With Audio"
description: "Call Gemini Realtime API with Audio Input/Output :::info Requires LiteLLM Proxy v1.70.1+ ::: 1. Setup config.yaml for LiteLLM Proxy 2. Start LiteLLM Proxy 3. Run test script"
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/gemini_realtime_with_audio.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/gemini_realtime_with_audio.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/gemini_realtime_with_audio.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/gemini_realtime_with_audio.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
