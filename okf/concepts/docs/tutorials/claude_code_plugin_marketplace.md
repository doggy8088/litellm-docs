...
description: "Claude Code Plugin Marketplace (Managed Skills) LiteLLM AI Gateway acts as a central registry for Claude Code plugins. Admins can govern which plugins are available across the o..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_plugin_marketplace.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/claude_code_plugin_marketplace.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/claude_code_plugin_marketplace.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_plugin_marketplace.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
