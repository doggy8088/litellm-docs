...
title: "Claude Code Byok"
description: "Claude Code with Bring Your Own Key (BYOK) Use Claude Code with your own Anthropic API key through the LiteLLM proxy. When you use Claude's /login with your Anthropic account, y..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_byok.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/claude_code_byok.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/claude_code_byok.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_byok.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
