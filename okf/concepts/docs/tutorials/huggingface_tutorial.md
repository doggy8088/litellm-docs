...
description: "Llama2 Huggingface Tutorial Huggingface is an open source platform to deploy machine learnings models. Call Llama2 with Huggingface Inference Endpoints LiteLLM makes it easy to..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/huggingface_tutorial.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/huggingface_tutorial.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/huggingface_tutorial.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/huggingface_tutorial.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
