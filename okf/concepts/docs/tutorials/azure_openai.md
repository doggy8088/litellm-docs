...
title: "Azure Openai"
description: "Replacing OpenAI ChatCompletion with Completion() Supported OpenAI LLMs Supported Azure OpenAI LLMs Completion() Quick Start Completion() with Streaming Completion() with Stream..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/azure_openai.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/azure_openai.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/azure_openai.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/azure_openai.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
