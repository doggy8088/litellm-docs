...
title: "Cost Tracking Coding"
description: "Track Usage for Coding Tools Track usage and costs for AI powered coding tools like Claude Code, Roo Code, Gemini CLI, and OpenAI Codex through LiteLLM. Monitor requests, costs,..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/cost_tracking_coding.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/cost_tracking_coding.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/cost_tracking_coding.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/cost_tracking_coding.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
