...
title: "Scim Litellm"
description: "SCIM with LiteLLM ✨ Enterprise : SCIM support requires a premium license. Enables identity providers (Okta, Azure AD, OneLogin, etc.) to automate user and team (group) provision..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/scim_litellm.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/scim_litellm.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/scim_litellm.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/scim_litellm.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
