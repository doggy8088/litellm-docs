...
description: "Claude Agent SDK with LiteLLM Use Anthropic's Claude Agent SDK with any LLM provider through LiteLLM Proxy. The Claude Agent SDK provides a high level interface for building AI..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_agent_sdk.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/claude_agent_sdk.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/claude_agent_sdk.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_agent_sdk.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
