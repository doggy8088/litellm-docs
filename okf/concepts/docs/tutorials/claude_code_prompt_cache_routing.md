...
description: "Claude Code Prompt Cache Routing Claude's Prompt Caching feature helps to optimize API usage through attempting to cache prompts and re use cached prompts during subsequent API..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_prompt_cache_routing.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/claude_code_prompt_cache_routing.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/claude_code_prompt_cache_routing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_prompt_cache_routing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
