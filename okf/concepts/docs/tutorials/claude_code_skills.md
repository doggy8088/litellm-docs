...
description: "LiteLLM Skills litellm skills is a collection of Agent Skills for managing a live LiteLLM proxy. Install them once and any agent that supports the Agent Skills standard (Claude..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_skills.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/claude_code_skills.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/claude_code_skills.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_skills.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
