...
description: "Claude Desktop (Cowork) Integration Route Claude Desktop requests through LiteLLM Proxy to get unified logging, budget controls, and access to any model. Quick Reference | Setti..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_desktop_cowork.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/claude_desktop_cowork.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/claude_desktop_cowork.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_desktop_cowork.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
