...
description: "Elasticsearch Logging with LiteLLM Send your LLM requests, responses, costs, and performance data to Elasticsearch for analytics and monitoring using OpenTelemetry. Quick Start..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/elasticsearch_logging.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/elasticsearch_logging.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/elasticsearch_logging.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/elasticsearch_logging.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
