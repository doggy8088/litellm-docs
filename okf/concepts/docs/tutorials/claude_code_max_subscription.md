...
description: "Using Claude Code Max Subscription Route Claude Code Max subscription traffic through LiteLLM AI Gateway. Why Claude Code Max over direct API? Lower costs — Claude Code Max subs..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_max_subscription.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/claude_code_max_subscription.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/claude_code_max_subscription.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/claude_code_max_subscription.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
