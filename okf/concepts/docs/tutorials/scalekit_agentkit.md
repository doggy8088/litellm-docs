...
description: "Scalekit with LiteLLM Add authenticated tool calls to your LiteLLM powered agents. Scalekit manages OAuth flows, token storage, and API execution for 100+ third party apps (Gmai..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/scalekit_agentkit.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/scalekit_agentkit.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/scalekit_agentkit.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/scalekit_agentkit.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
