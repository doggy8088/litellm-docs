...
description: "OpenClaw + LiteLLM Integration OpenClaw is a self hosted AI assistant that connects chat apps (WhatsApp, Telegram, Discord, and more) to LLM providers. By routing OpenClaw throu..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/openclaw_integration.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/openclaw_integration.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/openclaw_integration.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/openclaw_integration.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
