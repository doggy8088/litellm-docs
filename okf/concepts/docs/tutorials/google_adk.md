...
title: "Google Adk"
description: "Google ADK with LiteLLM Use Google ADK with LiteLLM Python SDK, LiteLLM Proxy This tutorial shows you how to create intelligent agents using Agent Development Kit (ADK) with sup..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/google_adk.md"
tags: ["docs","documentation-page"]
source_path: "docs/tutorials/google_adk.md"
source_area: "docs"
...
This concept mirrors [`docs/tutorials/google_adk.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/tutorials/google_adk.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
