...
title: "Moderation"
description: "/moderations Usage For /moderations endpoint, there is no need to specify model in the request or on the litellm config.yaml 1. Setup config.yaml 2. Start litellm proxy server I..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/moderation.md"
tags: ["docs","documentation-page"]
source_path: "docs/moderation.md"
source_area: "docs"
...
This concept mirrors [`docs/moderation.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/moderation.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
