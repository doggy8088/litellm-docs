...
description: "/memory CRUD endpoints for storing and retrieving user/team scoped memory entries on the LiteLLM proxy. Use these to persist conversation context, agent memory, team playbooks,..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/memory_management.md"
tags: ["docs","documentation-page"]
source_path: "docs/memory_management.md"
source_area: "docs"
...
This concept mirrors [`docs/memory_management.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/memory_management.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
