...
title: "Contributing"
description: "Contributing UI Thanks for contributing to the LiteLLM UI! This guide will help you set up your local development environment. 1. Clone the repo 2. Start the Proxy Create a conf..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/contributing.md"
...
This concept mirrors [`docs/contributing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/contributing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
