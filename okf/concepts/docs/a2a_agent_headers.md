...
title: "A2a Agent Headers"
description: "A2A Agent Authentication Headers Forward authentication credentials (Bearer tokens, API keys, etc.) from clients to backend A2A agents. Overview When LiteLLM proxies a request t..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/a2a_agent_headers.md"
tags: ["docs","documentation-page"]
source_path: "docs/a2a_agent_headers.md"
source_area: "docs"
...
This concept mirrors [`docs/a2a_agent_headers.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/a2a_agent_headers.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
