...
title: "Replicate"
description: "Replicate LiteLLM supports all models on Replicate Usage API KEYS Example Call 1. Add models to your config.yaml 2. Start the proxy 3. Send Request to LiteLLM Proxy Server Expec..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/replicate.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/replicate.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/replicate.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/replicate.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
