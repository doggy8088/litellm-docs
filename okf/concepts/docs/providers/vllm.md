...
title: "Vllm"
description: "VLLM LiteLLM supports all models on VLLM. | Property | Details | | | | | Description | vLLM is a fast and easy to use library for LLM inference and serving. Docs | | Provider Ro..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/vllm.md"
...
This concept mirrors [`docs/providers/vllm.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/vllm.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
