...
title: "Vertex Batch"
description: "Vertex Batch APIs Just add the following Vertex env vars to your environment. Usage Follow this complete workflow: create JSONL file → upload file → create batch → retrieve batc..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/vertex_batch.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/vertex_batch.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/vertex_batch.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/vertex_batch.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
