...
title: "Image Gen"
description: "Google AI Studio Image Generation Google AI Studio provides powerful image generation capabilities using Google's Imagen models to create high quality images from text descripti..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/google_ai_studio/image_gen.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/google_ai_studio/image_gen.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/google_ai_studio/image_gen.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/google_ai_studio/image_gen.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
