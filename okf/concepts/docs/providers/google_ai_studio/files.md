...
title: "Files"
description: "[BETA] Google AI Studio (Gemini) Files API Use this to upload files to Google AI Studio (Gemini). Useful to pass in large media files to Gemini's /generateContent endpoint. | Ac..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/google_ai_studio/files.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/google_ai_studio/files.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/google_ai_studio/files.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/google_ai_studio/files.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
