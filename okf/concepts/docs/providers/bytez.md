...
title: "Bytez"
description: "Bytez LiteLLM supports all chat models on Bytez! That also means multi modal models are supported 🔥 Tasks supported: chat , image text to text , audio text to text , video text..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/bytez.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/bytez.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/bytez.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/bytez.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
