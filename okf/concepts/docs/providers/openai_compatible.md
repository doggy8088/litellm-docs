...
description: "OpenAI Compatible Endpoints :::info Selecting openai as the provider routes your request to an OpenAI compatible endpoint using the upstream official OpenAI Python API library...."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/openai_compatible.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/openai_compatible.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/openai_compatible.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/openai_compatible.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
