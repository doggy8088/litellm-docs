...
title: "Azure Ai"
description: "Azure AI Studio LiteLLM supports all models on Azure AI Studio Usage ENV VAR Example Call 1. Add models to your config.yaml 2. Start the proxy 3. Send Request to LiteLLM Proxy S..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/azure_ai.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/azure_ai.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/azure_ai.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/azure_ai.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
