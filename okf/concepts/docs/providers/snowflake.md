...
title: "Snowflake"
description: "Snowflake Cortex LiteLLM supports all models on the Snowflake Cortex REST API, including models from Anthropic (Claude), OpenAI (GPT), Meta (Llama), Mistral, DeepSeek, and Snowf..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/snowflake.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/snowflake.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/snowflake.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/snowflake.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
