...
title: "Datarobot"
description: "DataRobot LiteLLM supports all models from DataRobot. Select datarobot as the provider to route your request through the datarobot OpenAI compatible endpoint using the upstream..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/datarobot.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/datarobot.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/datarobot.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/datarobot.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
