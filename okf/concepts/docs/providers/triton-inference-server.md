...
description: "Triton Inference Server LiteLLM supports Embedding Models on Triton Inference Servers | Property | Details | | | | | Description | NVIDIA Triton Inference Server | | Provider Ro..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/triton-inference-server.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/triton-inference-server.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/triton-inference-server.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/triton-inference-server.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
