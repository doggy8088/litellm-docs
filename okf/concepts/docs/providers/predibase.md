...
title: "Predibase"
description: "Predibase LiteLLM supports all models on Predibase Usage API KEYS Example Call 1. Add models to your config.yaml 2. Start the proxy 3. Send Request to LiteLLM Proxy Server Advan..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/predibase.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/predibase.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/predibase.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/predibase.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
