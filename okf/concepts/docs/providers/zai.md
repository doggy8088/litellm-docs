...
title: "Zai"
description: "Z.AI (Zhipu AI) https://z.ai/ We support Z.AI GLM text/chat models, just set zai/ as a prefix when sending completion requests API Key Sample Usage Sample Usage Streaming Suppor..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/zai.md"
...
This concept mirrors [`docs/providers/zai.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/zai.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
