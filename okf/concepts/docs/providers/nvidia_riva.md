...
title: "Nvidia Riva"
description: "Nvidia Riva (Speech to Text) LiteLLM supports NVIDIA Riva for speech to text via /audio/transcriptions . Works with both the NVCF hosted Riva endpoint (e.g. Parakeet on build.nv..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/nvidia_riva.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/nvidia_riva.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/nvidia_riva.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/nvidia_riva.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
