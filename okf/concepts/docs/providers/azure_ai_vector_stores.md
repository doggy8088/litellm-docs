...
title: "Azure Ai Vector Stores"
description: "Azure AI Search Vector Store (Unified API) Use this to search Azure AI Search Vector Stores, with LiteLLM's unified /chat/completions API. Quick Start You need three things: 1...."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/azure_ai_vector_stores.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/azure_ai_vector_stores.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/azure_ai_vector_stores.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/azure_ai_vector_stores.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
