...
title: "Codestral"
description: "Codestral API [Mistral AI] Codestral is available in select code completion plugins but can also be queried directly. See the documentation for more details. API Key FIM / Compl..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/codestral.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/codestral.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/codestral.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/codestral.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
