...
description: "Vertex AI Agent Engine Call Vertex AI Agent Engine (Reasoning Engines) in the OpenAI Request/Response format. | Property | Details | | | | | Description | Vertex AI Agent Engine..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/vertex_ai_agent_engine.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/vertex_ai_agent_engine.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/vertex_ai_agent_engine.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/vertex_ai_agent_engine.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
