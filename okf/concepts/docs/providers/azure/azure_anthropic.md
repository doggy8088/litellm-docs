...
description: "Azure Anthropic (Claude via Azure Foundry) LiteLLM supports Claude models deployed via Microsoft Azure Foundry, including Claude Sonnet 4.5, Claude Haiku 4.5, and Claude Opus 4...."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/azure/azure_anthropic.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/azure/azure_anthropic.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/azure/azure_anthropic.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/azure/azure_anthropic.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
