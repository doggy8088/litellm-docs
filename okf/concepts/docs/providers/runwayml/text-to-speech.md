...
description: "RunwayML Text to Speech Overview | Property | Details | | | | | Description | RunwayML provides high quality AI powered text to speech with natural sounding voices | | Provider..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/runwayml/text-to-speech.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/runwayml/text-to-speech.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/runwayml/text-to-speech.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/runwayml/text-to-speech.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
