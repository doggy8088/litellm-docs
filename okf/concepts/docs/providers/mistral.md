...
title: "Mistral"
description: "Mistral AI API https://docs.mistral.ai/api/ API Key Sample Usage Sample Usage Streaming Usage with LiteLLM Proxy 1. Set Mistral Models on config.yaml 2. Start Proxy 3. Test it S..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/mistral.md"
...
This concept mirrors [`docs/providers/mistral.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/mistral.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
