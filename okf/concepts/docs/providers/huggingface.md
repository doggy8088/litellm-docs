...
title: "Huggingface"
description: "Hugging Face LiteLLM supports running inference across multiple services for models hosted on the Hugging Face Hub. Serverless Inference Providers Hugging Face offers an easy an..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/huggingface.md"
...
This concept mirrors [`docs/providers/huggingface.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/huggingface.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
