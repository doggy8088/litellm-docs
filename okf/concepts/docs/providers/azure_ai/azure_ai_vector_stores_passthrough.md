...
title: "Azure Ai Vector Stores Passthrough"
description: "Azure AI Search Vector Store (Passthrough API) Use this to allow developers to create and search vector stores using the Azure AI Search API in the native Azure AI Search API fo..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/azure_ai/azure_ai_vector_stores_passthrough.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/azure_ai/azure_ai_vector_stores_passthrough.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/azure_ai/azure_ai_vector_stores_passthrough.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/azure_ai/azure_ai_vector_stores_passthrough.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
