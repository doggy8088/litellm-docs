...
title: "Openai"
description: "OpenAI LiteLLM supports OpenAI Chat + Embedding calls. :::tip We recommend using litellm.responses() / Responses API for the latest OpenAI models (GPT 5, gpt 5 codex, o3 mini, e..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/openai.md"
...
This concept mirrors [`docs/providers/openai.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/openai.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
