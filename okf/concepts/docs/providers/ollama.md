...
title: "Ollama"
description: "Ollama LiteLLM supports all models from Ollama :::info We recommend using ollama chat for better responses. ::: Pre requisites Ensure you have your ollama server running Example..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/ollama.md"
...
This concept mirrors [`docs/providers/ollama.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/ollama.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
