...
description: "Anthropic Programmatic Tool Calling Programmatic tool calling allows Claude to write code that calls your tools programmatically within a code execution container, rather than r..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/anthropic_programmatic_tool_calling.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/anthropic_programmatic_tool_calling.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/anthropic_programmatic_tool_calling.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/anthropic_programmatic_tool_calling.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
