...
title: "Azure Ai Img"
description: "Azure AI Image Generation (Black Forest Labs Flux) Azure AI provides powerful image generation capabilities using FLUX models from Black Forest Labs to create high quality image..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/azure_ai_img.md"
tags: ["docs","documentation-page"]
source_path: "docs/providers/azure_ai_img.md"
source_area: "docs"
...
This concept mirrors [`docs/providers/azure_ai_img.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/providers/azure_ai_img.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
