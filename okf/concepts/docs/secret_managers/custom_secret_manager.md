...
description: "Custom Secret Manager Integrate your custom secret management system with LiteLLM. Quick Start 1. Create Your Secret Manager Class Create a new file my secret manager.py with an..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/secret_managers/custom_secret_manager.md"
tags: ["docs","documentation-page"]
source_path: "docs/secret_managers/custom_secret_manager.md"
source_area: "docs"
...
This concept mirrors [`docs/secret_managers/custom_secret_manager.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/secret_managers/custom_secret_manager.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
