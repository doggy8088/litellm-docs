...
title: "Oidc"
description: "[BETA] OpenID Connect (OIDC) LiteLLM supports using OpenID Connect (OIDC) for authentication to upstream services . This allows you to avoid storing sensitive credentials in you..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/oidc.md"
tags: ["docs","documentation-page"]
source_path: "docs/oidc.md"
source_area: "docs"
...
This concept mirrors [`docs/oidc.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/oidc.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
