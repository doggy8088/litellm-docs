...
description: "/completions Overview | Feature | Supported | Notes | | | | | | Cost Tracking | ✅ | Works with all supported models | | Logging | ✅ | Works across all integrations | | End user..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/text_completion.md"
tags: ["docs","documentation-page"]
source_path: "docs/text_completion.md"
source_area: "docs"
...
This concept mirrors [`docs/text_completion.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/text_completion.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
