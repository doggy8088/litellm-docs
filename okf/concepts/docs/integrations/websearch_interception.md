...
title: "Websearch Interception"
description: "Web Search Integration Enable transparent server side web search execution for any LLM provider. LiteLLM automatically intercepts web search tool calls and executes them using y..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/integrations/websearch_interception.md"
tags: ["docs","documentation-page"]
source_path: "docs/integrations/websearch_interception.md"
source_area: "docs"
...
This concept mirrors [`docs/integrations/websearch_interception.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/integrations/websearch_interception.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
