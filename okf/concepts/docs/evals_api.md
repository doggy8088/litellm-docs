...
title: "Evals Api"
description: "/evals LiteLLM Proxy supports OpenAI's Evaluations (Evals) API, allowing you to create, manage, and run evaluations to measure model performance against defined testing criteria..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/evals_api.md"
tags: ["docs","documentation-page"]
source_path: "docs/evals_api.md"
source_area: "docs"
...
This concept mirrors [`docs/evals_api.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/evals_api.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
