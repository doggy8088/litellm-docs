...
title: "Openmeter"
description: "OpenMeter OpenMeter is an Open Source Usage Based Billing solution for AI/Cloud applications. It integrates with Stripe for easy billing. :::info We want to learn how we can mak..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/openmeter.md"
tags: ["docs","documentation-page"]
source_path: "docs/observability/openmeter.md"
source_area: "docs"
...
This concept mirrors [`docs/observability/openmeter.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/openmeter.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
