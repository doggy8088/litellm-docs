...
description: "Sumo Logic Send LiteLLM logs to Sumo Logic for observability, monitoring, and analysis. Sumo Logic is a cloud native machine data analytics platform that provides real time insi..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/sumologic_integration.md"
tags: ["docs","documentation-page"]
source_path: "docs/observability/sumologic_integration.md"
source_area: "docs"
...
This concept mirrors [`docs/observability/sumologic_integration.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/sumologic_integration.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
