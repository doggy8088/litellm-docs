...
title: "Braintrust"
description: "Braintrust Braintrust manages evaluations, logging, prompt playground, to data management for AI products. Quick Start OpenAI Proxy Usage 1. Add keys to env 2. Add braintrust to..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/braintrust.md"
tags: ["docs","documentation-page"]
source_path: "docs/observability/braintrust.md"
source_area: "docs"
...
This concept mirrors [`docs/observability/braintrust.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/braintrust.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
