...
description: "PostHog What is PostHog? PostHog is an open source product analytics platform that helps you track and analyze how users interact with your product. For LLM applications, PostHo..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/posthog_integration.md"
tags: ["docs","documentation-page"]
source_path: "docs/observability/posthog_integration.md"
source_area: "docs"
...
This concept mirrors [`docs/observability/posthog_integration.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/posthog_integration.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
