...
title: "Newrelic"
description: "New Relic Prerequisite In order to use LiteLLM with New Relic, you will need to have a New Relic account and license key. If you do not have a New Relic account yet, you can cre..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/newrelic.md"
tags: ["docs","documentation-page"]
source_path: "docs/observability/newrelic.md"
source_area: "docs"
...
This concept mirrors [`docs/observability/newrelic.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/newrelic.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
