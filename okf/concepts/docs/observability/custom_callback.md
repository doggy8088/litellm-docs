...
description: "Custom Callbacks :::info For PROXY Go Here ::: Callback Class You can create a custom callback class to precisely log events as they occur in litellm. Common Hooks async log suc..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/custom_callback.md"
tags: ["docs","documentation-page"]
source_path: "docs/observability/custom_callback.md"
source_area: "docs"
...
This concept mirrors [`docs/observability/custom_callback.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/custom_callback.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
