...
description: "Langfuse What is Langfuse? Langfuse (GitHub) is an open source LLM engineering platform for model tracing, prompt management, and application evaluation. Langfuse helps teams to..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/langfuse_integration.md"
tags: ["docs","documentation-page"]
source_path: "docs/observability/langfuse_integration.md"
source_area: "docs"
...
This concept mirrors [`docs/observability/langfuse_integration.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/langfuse_integration.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
