...
title: "Generic Api"
description: "Generic API Send LiteLLM logs to any HTTP endpoint. Quick Start Configuration Basic Setup Parameters | Parameter | Type | Required | Description | | | | | | | callback type | st..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/generic_api.md"
tags: ["docs","documentation-page"]
source_path: "docs/observability/generic_api.md"
source_area: "docs"
...
This concept mirrors [`docs/observability/generic_api.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/generic_api.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
