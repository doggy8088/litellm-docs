...
description: "Splunk Observability Cloud Send LiteLLM traces to Splunk Observability Cloud using the built in otel callback and standard OpenTelemetry OTLP environment variables. LiteLLM uses..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/splunk_observability_cloud.md"
tags: ["docs","documentation-page"]
source_path: "docs/observability/splunk_observability_cloud.md"
source_area: "docs"
...
This concept mirrors [`docs/observability/splunk_observability_cloud.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/splunk_observability_cloud.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
