...
description: "LangSmith An all in one developer platform for every step of the application lifecycle https://smith.langchain.com/ :::info We want to learn how we can make the callbacks better..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/langsmith_integration.md"
tags: ["docs","documentation-page"]
source_path: "docs/observability/langsmith_integration.md"
source_area: "docs"
...
This concept mirrors [`docs/observability/langsmith_integration.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/observability/langsmith_integration.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
