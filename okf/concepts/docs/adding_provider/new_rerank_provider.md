...
title: "New Rerank Provider"
description: "Add Rerank Provider LiteLLM follows the Cohere Rerank API format for all rerank providers. Here's how to add a new rerank provider: 1. Create a transformation.py file Create a c..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/adding_provider/new_rerank_provider.md"
tags: ["docs","documentation-page"]
source_path: "docs/adding_provider/new_rerank_provider.md"
source_area: "docs"
...
This concept mirrors [`docs/adding_provider/new_rerank_provider.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/adding_provider/new_rerank_provider.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
