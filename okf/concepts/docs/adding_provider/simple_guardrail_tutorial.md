...
title: "Simple Guardrail Tutorial"
description: "Adding a New Guardrail Integration You're going to create a class that checks text before it goes to the LLM or after it comes back. If it violates your rules, you block it. How..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/adding_provider/simple_guardrail_tutorial.md"
tags: ["docs","documentation-page"]
source_path: "docs/adding_provider/simple_guardrail_tutorial.md"
source_area: "docs"
...
This concept mirrors [`docs/adding_provider/simple_guardrail_tutorial.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/adding_provider/simple_guardrail_tutorial.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
