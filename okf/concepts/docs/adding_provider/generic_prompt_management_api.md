...
title: "Generic Prompt Management Api"
description: "[BETA] Generic Prompt Management API Integrate Without a PR The Problem As a prompt management provider, integrating with LiteLLM traditionally requires: Making a PR to the Lite..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/adding_provider/generic_prompt_management_api.md"
tags: ["docs","documentation-page"]
source_path: "docs/adding_provider/generic_prompt_management_api.md"
source_area: "docs"
...
This concept mirrors [`docs/adding_provider/generic_prompt_management_api.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/adding_provider/generic_prompt_management_api.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
