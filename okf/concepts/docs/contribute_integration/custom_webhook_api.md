...
description: "Contribute Custom Webhook API If your API just needs a Webhook event from LiteLLM, here's how to add a 'native' integration for it on LiteLLM: 1. Clone the repo and open the gen..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/contribute_integration/custom_webhook_api.md"
tags: ["docs","documentation-page"]
source_path: "docs/contribute_integration/custom_webhook_api.md"
source_area: "docs"
...
This concept mirrors [`docs/contribute_integration/custom_webhook_api.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/contribute_integration/custom_webhook_api.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
