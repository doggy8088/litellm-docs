...
title: "Mcp Toolsets"
description: "MCP Toolsets A Toolset is a named collection of specific tools drawn from one or more MCP servers. Instead of giving an agent access to every tool on every server, you pick exac..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_toolsets.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_toolsets.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_toolsets.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_toolsets.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
