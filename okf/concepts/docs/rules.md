...
title: "Rules"
description: "Rules Use this to fail a request based on the input or output of an llm api call. Available Endpoints litellm.pre call rules = [] A list of functions to iterate over before maki..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/rules.md"
...
This concept mirrors [`docs/rules.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/rules.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
