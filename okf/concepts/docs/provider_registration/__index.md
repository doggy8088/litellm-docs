...
description: "Quick Start for OpenAI Compatible Providers If your API is OpenAI compatible, you can add support by editing a single JSON file. See Adding OpenAI Compatible Providers for the s..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/provider_registration/index.md"
tags: ["docs","documentation-page"]
source_path: "docs/provider_registration/index.md"
source_area: "docs"
...
This concept mirrors [`docs/provider_registration/index.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/provider_registration/index.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
