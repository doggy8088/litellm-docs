...
description: "To add pricing or context window information for a model, simply make a PR to this file: model prices and context window.json Sample Spec Here's the full specification with all..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/provider_registration/add_model_pricing.md"
tags: ["docs","documentation-page"]
source_path: "docs/provider_registration/add_model_pricing.md"
source_area: "docs"
...
This concept mirrors [`docs/provider_registration/add_model_pricing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/provider_registration/add_model_pricing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
