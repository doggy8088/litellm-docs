...
description: "Provider Files Endpoints Files are used to upload documents that can be used with features like Assistants, Fine tuning, and Batch API. Use this to call the provider's /files en..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/files_endpoints.md"
tags: ["docs","documentation-page"]
source_path: "docs/files_endpoints.md"
source_area: "docs"
...
This concept mirrors [`docs/files_endpoints.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/files_endpoints.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
