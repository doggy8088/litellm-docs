...
title: "Messages To Responses Mapping"
description: "v1/messages → /responses Parameter Mapping When you send a request to /v1/messages targeting an OpenAI or Azure model, LiteLLM internally routes it through the OpenAI Responses..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/anthropic_unified/messages_to_responses_mapping.md"
tags: ["docs","documentation-page"]
source_path: "docs/anthropic_unified/messages_to_responses_mapping.md"
source_area: "docs"
...
This concept mirrors [`docs/anthropic_unified/messages_to_responses_mapping.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/anthropic_unified/messages_to_responses_mapping.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
