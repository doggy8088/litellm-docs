...
description: "Vertex AI Search Datastores Call Vertex AI Discovery Engine Search API through LiteLLM. Provider Doc: https://cloud.google.com/generative ai app builder/docs/reference/rest/v1/p..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/pass_through/vertex_ai_search_datastores.md"
tags: ["docs","documentation-page"]
source_path: "docs/pass_through/vertex_ai_search_datastores.md"
source_area: "docs"
...
This concept mirrors [`docs/pass_through/vertex_ai_search_datastores.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/pass_through/vertex_ai_search_datastores.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
