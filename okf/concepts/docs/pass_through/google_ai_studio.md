...
description: "Google AI Studio SDK Pass through endpoints for Google AI Studio call provider specific endpoint, in native format (no translation). | Feature | Supported | Notes | | | | | | Co..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/pass_through/google_ai_studio.md"
tags: ["docs","documentation-page"]
source_path: "docs/pass_through/google_ai_studio.md"
source_area: "docs"
...
This concept mirrors [`docs/pass_through/google_ai_studio.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/pass_through/google_ai_studio.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
