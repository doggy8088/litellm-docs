...
title: "Cursor"
description: "Cursor Cloud Agents Pass through endpoints for the Cursor Cloud Agents API — launch and manage cloud agents that work on your repositories, in native format (no translation). |..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/pass_through/cursor.md"
tags: ["docs","documentation-page"]
source_path: "docs/pass_through/cursor.md"
source_area: "docs"
...
This concept mirrors [`docs/pass_through/cursor.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/pass_through/cursor.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
