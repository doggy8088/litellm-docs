...
title: "Vertex Ai Live Websocket"
description: "Vertex AI Live API WebSocket Passthrough LiteLLM now supports WebSocket passthrough for the Vertex AI Live API, enabling real time bidirectional communication with Gemini models..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/pass_through/vertex_ai_live_websocket.md"
tags: ["docs","documentation-page"]
source_path: "docs/pass_through/vertex_ai_live_websocket.md"
source_area: "docs"
...
This concept mirrors [`docs/pass_through/vertex_ai_live_websocket.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/pass_through/vertex_ai_live_websocket.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
