...
title: "Jwt Auth Arch"
description: "Control Model Access with OIDC (Azure AD/Keycloak/etc.) :::info ✨ JWT Auth is on LiteLLM Enterprise Enterprise Pricing Get free 7 day trial key ::: Example Token Proxy Configura..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/jwt_auth_arch.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/jwt_auth_arch.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/jwt_auth_arch.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/jwt_auth_arch.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
