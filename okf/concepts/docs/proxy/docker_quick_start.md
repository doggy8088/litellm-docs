...
description: "Getting Started Tutorial End to End tutorial for LiteLLM Proxy to: Add an Azure OpenAI model Make a successful /chat/completion call Generate a virtual key Set RPM limit on virt..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/docker_quick_start.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/docker_quick_start.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/docker_quick_start.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/docker_quick_start.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
