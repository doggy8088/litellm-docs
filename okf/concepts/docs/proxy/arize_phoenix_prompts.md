...
description: "Arize Phoenix Prompt Management Use prompt versions from Arize Phoenix with LiteLLM SDK and Proxy. Quick Start SDK Proxy 1. Add prompt to config 2. Make request Configuration Ge..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/arize_phoenix_prompts.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/arize_phoenix_prompts.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/arize_phoenix_prompts.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/arize_phoenix_prompts.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
