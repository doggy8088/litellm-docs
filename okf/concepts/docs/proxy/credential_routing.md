...
description: "Per Team/Project Credential Routing Route the same model to different LLM provider endpoints (e.g. different Azure instances) based on which team or project makes the request. O..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/credential_routing.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/credential_routing.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/credential_routing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/credential_routing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
