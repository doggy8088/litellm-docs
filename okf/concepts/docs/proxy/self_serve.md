...
title: "Self Serve"
description: "Internal User Self Serve Allow users to create their own keys on Proxy UI. 1. Add user with permissions to a team on proxy Go to Internal Users +New User Create a new Internal U..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/self_serve.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/self_serve.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/self_serve.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/self_serve.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
