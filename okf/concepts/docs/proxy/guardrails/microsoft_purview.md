...
description: "Microsoft Purview Guardrail LiteLLM supports Microsoft Purview DLP policies via the Microsoft Graph processContent API. Supported modes | Mode | What it does | | | | | pre call..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/microsoft_purview.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/microsoft_purview.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/microsoft_purview.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/microsoft_purview.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
