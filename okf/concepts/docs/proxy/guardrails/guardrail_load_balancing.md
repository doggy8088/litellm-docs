...
description: "Guardrail Load Balancing Load balance guardrail requests across multiple guardrail deployments. This is useful when you have rate limits on guardrail providers (e.g., AWS Bedroc..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/guardrail_load_balancing.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/guardrail_load_balancing.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/guardrail_load_balancing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/guardrail_load_balancing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
