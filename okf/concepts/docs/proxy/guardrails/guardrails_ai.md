...
title: "Guardrails Ai"
description: "Guardrails AI Use Guardrails AI (guardrailsai.com) to add checks to LLM output. Pre requisites Setup Guardrails AI Server. quick start Usage 1. Setup config.yaml 2. Start LiteLL..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/guardrails_ai.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/guardrails_ai.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/guardrails_ai.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/guardrails_ai.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
