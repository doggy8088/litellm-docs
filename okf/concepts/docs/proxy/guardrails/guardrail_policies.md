...
description: "[Beta] Guardrail Policies Use policies to group guardrails and control which ones run for specific teams, keys, or models. Why use policies? Enable/disable specific guardrails f..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/guardrail_policies.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/guardrail_policies.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/guardrail_policies.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/guardrail_policies.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
