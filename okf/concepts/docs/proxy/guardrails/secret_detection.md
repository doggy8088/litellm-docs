...
description: "✨ Secret Detection/Redaction (Enterprise only) ❓ Use this to REDACT API Keys, Secrets sent in requests to an LLM. Example if you want to redact the value of OPENAI API KEY in th..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/secret_detection.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/secret_detection.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/secret_detection.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/secret_detection.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
