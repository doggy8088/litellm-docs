...
description: "Custom Guardrail Use this if you want to write code to run a custom guardrail Quick Start 1. Write a CustomGuardrail Class The simplest way to create a custom guardrail is by im..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/custom_guardrail.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/custom_guardrail.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/custom_guardrail.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/custom_guardrail.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
