...
title: "Cato Networks"
description: "Cato Networks Quick Start 1. Create a new Cato Networks AI Security Guard Go to Cato Networks CMA and create a new AI Security guard. Name your guard and select the AI Gateway o..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/cato_networks.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/cato_networks.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/cato_networks.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/cato_networks.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
