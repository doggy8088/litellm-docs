...
description: "Zscaler AI Guard Overview Zscaler AI Guard enforces security policies for all traffic to AI sites, models, and applications. As part of the Zero Trust Exchange, it provides a co..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/zscaler_ai_guard.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/zscaler_ai_guard.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/zscaler_ai_guard.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/zscaler_ai_guard.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
