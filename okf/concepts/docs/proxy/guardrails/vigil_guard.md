...
title: "Vigil Guard"
description: "Vigil Guard Use Vigil Guard as a LiteLLM proxy guardrail to evaluate chat input and model output before it is returned to your application. Supported endpoints: The Vigil Guard..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/vigil_guard.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/vigil_guard.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/vigil_guard.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/vigil_guard.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
