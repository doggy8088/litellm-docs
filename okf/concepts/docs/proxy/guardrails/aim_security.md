...
title: "Aim Security"
description: "Aim Security Quick Start 1. Create a new Aim Guard Go to Aim Application and create a new guard. When prompted, select API option, and name your guard. :::note In case you want..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/aim_security.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/aim_security.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/aim_security.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/aim_security.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
