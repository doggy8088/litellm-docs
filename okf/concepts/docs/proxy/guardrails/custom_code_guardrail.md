...
description: "Custom Code Guardrail Write custom guardrail logic using Python like code that runs in a sandboxed environment. Quick Start 1. Define the guardrail in config 2. Start proxy 3. T..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/custom_code_guardrail.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/custom_code_guardrail.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/custom_code_guardrail.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/custom_code_guardrail.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
