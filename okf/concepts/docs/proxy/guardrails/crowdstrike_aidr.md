...
description: "CrowdStrike AIDR The CrowdStrike AIDR guardrail uses configurable detection policies to identify and mitigate risks in AI application traffic, including: Prompt injection attack..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/crowdstrike_aidr.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/crowdstrike_aidr.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/crowdstrike_aidr.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/crowdstrike_aidr.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
