...
description: "LiteLLM Tool Permission Guardrail LiteLLM provides the LiteLLM Tool Permission Guardrail that lets you control which tool calls a model is allowed to invoke, using configurable..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/tool_permission.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/tool_permission.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/tool_permission.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/tool_permission.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
