...
description: "Guardrail Testing Playground Test and compare multiple guardrails in real time with an interactive playground interface. How to Use the Guardrail Testing Playground The Guardrai..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/test_playground.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/test_playground.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/test_playground.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/test_playground.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
