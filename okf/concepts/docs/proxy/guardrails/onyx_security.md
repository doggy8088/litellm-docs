...
title: "Onyx Security"
description: "Onyx Security Quick Start 1. Create a new Onyx Guard policy Go to Onyx's platform and create a new AI Guard policy. After creating the policy, copy the generated API key. 2. Def..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/onyx_security.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/onyx_security.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/onyx_security.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/onyx_security.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
