...
description: "IBM Guardrails LiteLLM works with IBM's FMS Guardrails for content safety. You can use it to detect jailbreaks, PII, hate speech, and more. What it does IBM's FMS Guardrails is..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/ibm_guardrails.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/ibm_guardrails.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/ibm_guardrails.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/ibm_guardrails.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
