...
title: "Lakera Ai"
description: "Lakera AI Supported endpoints: The Lakera v2 integration only supports the chat completions endpoint ( /v1/chat/completions ). It is not supported for the Responses API, /v1/mes..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/lakera_ai.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/lakera_ai.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/lakera_ai.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/lakera_ai.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
