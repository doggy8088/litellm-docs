...
description: "PANW Prisma AIRS LiteLLM supports PANW Prisma AIRS (AI Runtime Security) guardrails via the Prisma AIRS Scan API. This integration provides Security as Code for AI applications..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/panw_prisma_airs.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/panw_prisma_airs.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/panw_prisma_airs.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/panw_prisma_airs.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
