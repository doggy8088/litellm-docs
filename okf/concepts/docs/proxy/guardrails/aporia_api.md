...
title: "Aporia Api"
description: "Aporia Use Aporia to detect PII in requests and profanity in responses 1. Setup guardrails on Aporia Create Aporia Projects Create two projects on Aporia 1. Pre LLM API Call Set..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/aporia_api.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/aporia_api.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/aporia_api.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/aporia_api.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
