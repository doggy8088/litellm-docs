...
description: "Realtime API Guardrails Guard voice conversations in the Realtime API — intercept speech transcriptions before the LLM responds. How it works The Realtime API is a long lived We..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/realtime_guardrails.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/realtime_guardrails.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/realtime_guardrails.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/realtime_guardrails.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
