...
description: "Policy Templates Policy templates provide pre configured guardrail policies that you can use as a starting point for your organization. Instead of manually creating policies and..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/policy_templates.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/policy_templates.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/policy_templates.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/policy_templates.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
