...
title: "Sensitive Data Routing"
description: "Sensitive Data Routing (Built in Guardrail) Built in guardrail that detects sensitive data in a request and reroutes it to an on premise model instead of blocking or redacting i..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/sensitive_data_routing.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/sensitive_data_routing.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/sensitive_data_routing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/sensitive_data_routing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
