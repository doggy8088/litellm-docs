...
title: "Rubrik"
description: "Rubrik Guardrail Use Rubrik's tool blocking and logging integration to validate LLM tool calls against an external policy service and batch log all LLM requests/responses. Key f..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/rubrik.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/rubrik.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/rubrik.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/rubrik.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
