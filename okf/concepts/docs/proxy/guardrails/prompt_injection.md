...
description: "In memory Prompt Injection Detection LiteLLM Supports the following methods for detecting prompt injection attacks Similarity Checks LLM API Call to check Similarity Checking Li..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/prompt_injection.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/guardrails/prompt_injection.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/guardrails/prompt_injection.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/guardrails/prompt_injection.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
