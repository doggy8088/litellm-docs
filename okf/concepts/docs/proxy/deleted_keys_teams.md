...
title: "Deleted Keys Teams"
description: "Deleted Keys & Teams Audit Logs View deleted API keys and teams along with their spend and budget information at the time of deletion for auditing and compliance purposes. Overv..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/deleted_keys_teams.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/deleted_keys_teams.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/deleted_keys_teams.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/deleted_keys_teams.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
