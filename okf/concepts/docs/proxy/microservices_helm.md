...
title: "Microservices Helm"
description: "Microservices Helm Run LiteLLM as three independently scalable services — a gateway for LLM traffic, a backend for the management/UI API, and a static ui — plus a one shot migra..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/microservices_helm.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/microservices_helm.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/microservices_helm.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/microservices_helm.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
