...
title: "Configs"
description: "Overview Set model list, api base , api key , temperature & proxy server settings ( master key ) on the config.yaml. | Param Name | Description | | | | | model list | List of su..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/configs.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/configs.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/configs.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/configs.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
