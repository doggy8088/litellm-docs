...
description: "Worker Startup Hooks Use LITELLM WORKER STARTUP HOOKS to run custom initialization functions in each worker process during proxy startup. This is essential when using multi work..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/worker_startup_hooks.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/worker_startup_hooks.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/worker_startup_hooks.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/worker_startup_hooks.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
