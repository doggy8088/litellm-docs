...
title: "Db Info"
description: "What is stored in the DB The LiteLLM Proxy uses a PostgreSQL database to store various information. Here's are the main features the DB is used for: Virtual Keys, Organizations,..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/db_info.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/db_info.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/db_info.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/db_info.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
