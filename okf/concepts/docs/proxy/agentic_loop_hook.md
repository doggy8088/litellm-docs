...
description: "Agentic Loop Hook Build a CustomLogger callback that intercepts a model response, fulfills tool calls server side, and reruns the model — transparently to the caller. :::info Su..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/agentic_loop_hook.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/agentic_loop_hook.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/agentic_loop_hook.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/agentic_loop_hook.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
