...
title: "Ui Logs"
description: "Getting Started with UI Logs View Spend, Token Usage, Key, Team Name for Each Request to LiteLLM Overview | Log Type | Tracked by Default | | | | | Success Logs | ✅ Yes | | Erro..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/ui_logs.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/ui_logs.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/ui_logs.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/ui_logs.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
