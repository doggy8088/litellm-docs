...
description: "How Model Access Works Concept Each model onboarded is a \"model deployment\" in LiteLLM. These model deployments are assigned to a \"model group\", via the \"model name\" field in th..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/model_access_guide.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/model_access_guide.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/model_access_guide.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/model_access_guide.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
