...
description: "[New] Fallback Management Endpoints Dedicated endpoints for managing model fallbacks separately from the general configuration. Overview These endpoints allow you to configure,..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/fallback_management.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/fallback_management.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/fallback_management.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/fallback_management.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
