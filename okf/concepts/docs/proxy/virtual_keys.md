...
title: "Virtual Keys"
description: "Virtual Keys Track Spend, and control model access via virtual keys for the proxy :::info 🔑 UI to Generate, Edit, Delete Keys (with SSO) Deploy LiteLLM Proxy with Key Managemen..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/virtual_keys.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/virtual_keys.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/virtual_keys.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/virtual_keys.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
