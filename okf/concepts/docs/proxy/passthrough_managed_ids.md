...
title: "Passthrough Managed Ids"
description: "Passthrough Managed IDs When you use LiteLLM's passthrough endpoints (e.g. /openai/v1/files , /azure/openai/batches ) the upstream provider returns its own raw IDs such as file..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/passthrough_managed_ids.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/passthrough_managed_ids.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/passthrough_managed_ids.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/passthrough_managed_ids.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
