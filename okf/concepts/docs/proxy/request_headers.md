...
description: "Request Headers Special headers that are supported by LiteLLM. Header Forwarding By default, LiteLLM does not forward client headers to LLM provider APIs. However, you can selec..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/request_headers.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/request_headers.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/request_headers.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/request_headers.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
