...
description: "Custom Prompt Management Connect LiteLLM to your prompt management system with custom hooks. Overview How it works Quick Start 1. Create Your Custom Prompt Manager Create a clas..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/custom_prompt_management.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/custom_prompt_management.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/custom_prompt_management.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/custom_prompt_management.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
