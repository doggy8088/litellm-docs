...
title: "Deploy"
description: "Docker, Helm, Terraform :::info No Limits on LiteLLM OSS There are no limits on the number of users, keys, or teams you can create on LiteLLM OSS. ::: You can find the Dockerfil..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/deploy.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/deploy.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/deploy.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/deploy.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
