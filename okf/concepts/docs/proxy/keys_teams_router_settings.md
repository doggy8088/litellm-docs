...
title: "Keys Teams Router Settings"
description: "UI Router Settings for Keys and Teams Configure router settings at the key and team level to achieve granular control over routing behavior, fallbacks, retries, and other router..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/keys_teams_router_settings.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/keys_teams_router_settings.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/keys_teams_router_settings.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/keys_teams_router_settings.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
