...
description: "UI Spend Log Settings Configure spend log behavior directly from the Admin UI—no config file edits or proxy restart required. This is especially useful for cloud deployments whe..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/ui_spend_log_settings.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/ui_spend_log_settings.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/ui_spend_log_settings.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/ui_spend_log_settings.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
