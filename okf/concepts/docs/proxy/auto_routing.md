...
title: "Auto Routing"
description: "Auto Routing One router for complexity, semantic, and adaptive routing. Classify each request with heuristics, an LLM classifier, or lexical/semantic keyword rules, then route t..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/auto_routing.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/auto_routing.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/auto_routing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/auto_routing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
