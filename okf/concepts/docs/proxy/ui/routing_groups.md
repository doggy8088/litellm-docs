...
description: "Manage Routing Groups Routing groups let you apply different routing strategies to different models in the same router — for example, latency based routing for gpt 4o while chea..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/ui/routing_groups.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/ui/routing_groups.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/ui/routing_groups.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/ui/routing_groups.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
