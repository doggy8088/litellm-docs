...
description: "[BETA] High Availability Control Plane Deploy a single LiteLLM UI that manages multiple independent LiteLLM proxy instances, each with its own database, Redis, and master key. :..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/high_availability_control_plane.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/high_availability_control_plane.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/high_availability_control_plane.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/high_availability_control_plane.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
