...
description: "Customer Usage Track and visualize end user spend directly in the dashboard. Monitor customer level usage analytics, spend logs, and activity metrics to understand how your cust..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/customer_usage.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/customer_usage.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/customer_usage.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/customer_usage.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
