...
title: "Token Auth"
description: "OIDC JWT based Auth Use JWT's to auth admins / users / projects into the proxy. :::info ✨ JWT based Auth is on LiteLLM Enterprise Enterprise Pricing Contact us here to get a fre..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/token_auth.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/token_auth.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/token_auth.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/token_auth.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
