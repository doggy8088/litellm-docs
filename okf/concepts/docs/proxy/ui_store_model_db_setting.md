...
title: "Ui Store Model Db Setting"
description: "Store Model in DB Settings Enable or disable storing model definitions in the database directly from the Admin UI—no config file edits or proxy restart required. This is especia..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/ui_store_model_db_setting.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/ui_store_model_db_setting.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/ui_store_model_db_setting.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/ui_store_model_db_setting.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
