...
title: "Ui Credentials"
description: "Adding LLM Credentials You can add LLM provider credentials on the UI. Once you add credentials you can reuse them when adding new models Add a credential + model 1. Navigate to..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/ui_credentials.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/ui_credentials.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/ui_credentials.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/ui_credentials.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
