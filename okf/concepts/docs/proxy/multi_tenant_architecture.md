...
description: "Multi Tenant Architecture with LiteLLM Overview LiteLLM provides a centralized solution that scales across multiple tenants, enabling organizations to: Centrally manage LLM acce..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/multi_tenant_architecture.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/multi_tenant_architecture.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/multi_tenant_architecture.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/multi_tenant_architecture.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
