...
description: "✨ Audit Logs As a Proxy Admin, you can check if and when a entity (key, team, user, model) was created, updated, deleted, or regenerated, along with who performed the action. Th..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/multiple_admins.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/multiple_admins.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/multiple_admins.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/multiple_admins.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
