...
title: "Ui"
description: "Quick Start Create keys, track spend, add models without worrying about the config / CRUD endpoints. Quick Start Requires proxy master key to be set Requires db connected Follow..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/ui.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/ui.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/ui.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/ui.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
