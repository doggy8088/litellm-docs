...
title: "Timeout"
description: "Timeouts The timeout set in router is for the entire length of the call, and is passed down to the completion() call level as well. Global Timeouts Start Proxy Custom Timeouts &..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/timeout.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/timeout.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/timeout.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/timeout.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
