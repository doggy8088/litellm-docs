...
title: "Plugins"
description: "Plugins Plugins let external services appear as selectable modes in the LiteLLM UI sidebar alongside the AI Gateway. Each plugin runs as its own backend; LiteLLM proxies request..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/plugins.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/plugins.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/plugins.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/plugins.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
