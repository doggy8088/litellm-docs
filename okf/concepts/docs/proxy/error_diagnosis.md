...
description: "Diagnosing Errors Provider vs Gateway Having trouble diagnosing if an error is from the LLM Provider (OpenAI, Anthropic, etc.) or from the LiteLLM AI Gateway itself? Here's how..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/error_diagnosis.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/error_diagnosis.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/error_diagnosis.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/error_diagnosis.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
