...
title: "Prod"
description: "⚡ Best Practices for Production 1. Use this config.yaml Use this config.yaml in production (with your own LLMs) :::warning Multiple instances If running multiple LiteLLM instanc..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/prod.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/prod.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/prod.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/prod.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
