...
description: "Provisioning identities and issuing keys A question that comes up with SSO deployments is whether a user provisioned through your identity provider (via SCIM) automatically ends..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/identity_provisioning.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/identity_provisioning.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/identity_provisioning.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/identity_provisioning.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
