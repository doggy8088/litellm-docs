...
title: "Model Compare Ui"
description: "Model Compare Playground UI Compare multiple LLM models side by side in an interactive playground interface. Evaluate model responses, performance metrics, and costs to make inf..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/model_compare_ui.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/model_compare_ui.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/model_compare_ui.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/model_compare_ui.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
