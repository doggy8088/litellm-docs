...
title: "Security Encryption Faq"
description: "LiteLLM Self Hosted Security & Encryption FAQ Data in Transit Encryption Does the product encrypt data in transit? Yes , LiteLLM encrypts data in transit using TLS/SSL. Availabl..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/security_encryption_faq.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/security_encryption_faq.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/security_encryption_faq.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/security_encryption_faq.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
