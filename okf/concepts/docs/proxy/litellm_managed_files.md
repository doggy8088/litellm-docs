...
title: "Litellm Managed Files"
description: "[BETA] LiteLLM Managed Files Reuse the same file across different providers. Prevent users from seeing files they don't have access to on list and retrieve calls. :::info This i..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/litellm_managed_files.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/litellm_managed_files.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/litellm_managed_files.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/litellm_managed_files.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
