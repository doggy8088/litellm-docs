...
description: "Docker Image Security Guide LiteLLM signs every Docker image published to GHCR with cosign starting from v1.83.0 . This page covers how to verify signatures, enforce verificatio..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/docker_image_security.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/docker_image_security.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/docker_image_security.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/docker_image_security.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
