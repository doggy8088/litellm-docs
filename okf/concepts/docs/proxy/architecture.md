...
title: "Architecture"
description: "Life of a Request High Level architecture Request Flow 1. User Sends Request : The process begins when a user sends a request to the LiteLLM Proxy Server (Gateway). 2. Virtual K..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/architecture.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/architecture.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/architecture.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/architecture.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
