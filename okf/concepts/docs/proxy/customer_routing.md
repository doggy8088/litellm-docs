...
description: "[DEPRECATED] Region based Routing :::info This is deprecated, please use Tag Based Routing instead ::: Route specific customers to eu only models. By specifying 'allowed model r..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/customer_routing.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/customer_routing.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/customer_routing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/customer_routing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
