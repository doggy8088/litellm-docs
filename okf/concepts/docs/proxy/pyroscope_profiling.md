...
description: "Grafana Pyroscope CPU profiling LiteLLM proxy can send continuous CPU profiles to Grafana Pyroscope when enabled via environment variables. This is optional and off by default...."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/pyroscope_profiling.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/pyroscope_profiling.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/pyroscope_profiling.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/pyroscope_profiling.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
