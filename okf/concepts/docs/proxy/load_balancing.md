...
description: "Proxy Load Balancing Load balance multiple instances of the same model The proxy will handle routing requests (using LiteLLM's Router). Set rpm in the config if you want maximiz..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/load_balancing.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/load_balancing.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/load_balancing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/load_balancing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
