...
title: "Team Budgets"
description: "Setting Team Budgets Pre Requisites You must set up a Postgres database (e.g. Supabase, Neon, etc.) Default Budget for Auto Generated JWT Teams When using JWT authentication wit..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/team_budgets.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/team_budgets.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/team_budgets.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/team_budgets.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
