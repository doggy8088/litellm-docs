...
title: "Oauth2"
description: "Oauth 2.0 Authentication Use this if you want to use an Oauth2.0 token to make /chat , /embeddings requests to the LiteLLM Proxy :::info This is an Enterprise Feature get in tou..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/oauth2.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/oauth2.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/oauth2.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/oauth2.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
