...
description: "Model Access Groups Overview Group multiple models under a single name, then grant keys or teams access to the entire group. Add or remove models from a group without updating i..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/model_access_groups.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/model_access_groups.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/model_access_groups.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/model_access_groups.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
