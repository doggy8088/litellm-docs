...
description: "Custom LLM Pricing Overview LiteLLM provides flexible cost tracking and pricing customization for all LLM providers: Custom Pricing Override default model costs or set pricing f..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/custom_pricing.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/custom_pricing.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/custom_pricing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/custom_pricing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
