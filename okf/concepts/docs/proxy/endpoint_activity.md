...
description: "Endpoint Activity Track and visualize API endpoint usage directly in the dashboard. Monitor endpoint level activity analytics, spend breakdowns, and performance metrics to under..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/endpoint_activity.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/endpoint_activity.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/endpoint_activity.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/endpoint_activity.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
