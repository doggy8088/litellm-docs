...
description: "LiteLLM AI Gateway Prompt Management Use the LiteLLM AI Gateway to create, manage and version your prompts. Quick Start Accessing the Prompts Interface 1. Navigate to Experiment..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/litellm_prompt_management.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/litellm_prompt_management.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/litellm_prompt_management.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/litellm_prompt_management.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
