...
description: "Response Headers When you make a request to the proxy, the proxy will return the following headers: Rate Limit Headers OpenAI compatible headers: | Header | Type | Description |..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/response_headers.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/response_headers.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/response_headers.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/response_headers.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
