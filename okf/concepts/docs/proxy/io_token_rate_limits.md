...
title: "Io Token Rate Limits"
description: "[Beta] Separate ITPM / OTPM Rate Limits Enforce input tokens per minute (ITPM) and output tokens per minute (OTPM) separately on router deployments. Use this when a provider pub..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/io_token_rate_limits.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/io_token_rate_limits.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/io_token_rate_limits.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/io_token_rate_limits.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
