...
description: "Database Read Replica LiteLLM Proxy can route read only queries to a separate database endpoint while writes continue to go to the primary. This is useful for Aurora style clust..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/db_read_replica.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/db_read_replica.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/db_read_replica.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/db_read_replica.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
