...
description: "Fee/Price Margin on LLM Costs Apply percentage based or fixed amount margins to specific providers or globally. This is useful for enterprises that need to add operational overh..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/provider_margins.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/provider_margins.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/provider_margins.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/provider_margins.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
