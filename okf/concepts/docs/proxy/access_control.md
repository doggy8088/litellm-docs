...
description: "Role based Access Controls (RBAC) Role based access control (RBAC) is based on Organizations, Teams and Internal User Roles Video Walkthrough Organizations are the top level ent..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/access_control.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/access_control.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/access_control.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/access_control.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
