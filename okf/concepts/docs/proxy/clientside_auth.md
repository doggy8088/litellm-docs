...
title: "Clientside Auth"
description: "Clientside LLM Credentials Pass User LLM API Keys, Fallbacks Allow your end users to pass their model list, api base, OpenAI API key (any LiteLLM supported provider) to make req..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/clientside_auth.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/clientside_auth.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/clientside_auth.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/clientside_auth.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
