...
description: "Prompt Management Run experiments or change the specific model (e.g. from gpt 4o to gpt4o mini finetune) from your prompt management tool (e.g. Langfuse) instead of making chang..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/prompt_management.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/prompt_management.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/prompt_management.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/prompt_management.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
