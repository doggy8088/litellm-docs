...
title: "Memory"
description: "Memory Management Store user preferences and feedback so your LLM remembers them across sessions. Scoped per user and team, with built in access control. Requires: LiteLLM v1.83..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/memory.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/memory.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/memory.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/memory.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
