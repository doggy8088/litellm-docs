...
title: "Health Check Routing"
description: "Health Check Driven Routing Route traffic away from unhealthy deployments before users hit errors. Background health checks run on a configurable interval, and any deployment th..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/health_check_routing.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/health_check_routing.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/health_check_routing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/health_check_routing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
