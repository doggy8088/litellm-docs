...
title: "Prometheus"
description: "📈 Prometheus metrics LiteLLM Exposes a /metrics endpoint for Prometheus to Poll Quick Start If you're using the LiteLLM CLI with litellm config proxy config.yaml then you need..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/prometheus.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/prometheus.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/prometheus.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/prometheus.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
