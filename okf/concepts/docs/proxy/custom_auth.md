...
title: "Custom Auth"
description: "Custom Auth You can now override the default api key auth. :::warning Enforcement with custom auth By default, custom auth enforces only the rate limits you set on the returned..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/custom_auth.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/custom_auth.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/custom_auth.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/custom_auth.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
