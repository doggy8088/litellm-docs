...
description: "[DEPRECATED] Team based Routing :::info This is deprecated, please use Tag Based Routing instead ::: Routing Route calls to different model groups based on the team id Config wi..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/team_based_routing.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/team_based_routing.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/team_based_routing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/team_based_routing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
