...
title: "Tag Budgets"
description: "Setting Tag Budgets Track spend and set budgets for your API requests using tags. Tags allow you to categorize and monitor costs across different cost centers, projects, and dep..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/tag_budgets.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/tag_budgets.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/tag_budgets.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/tag_budgets.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
