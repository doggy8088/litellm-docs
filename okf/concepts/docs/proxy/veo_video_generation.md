...
description: "Veo Video Generation with Google AI Studio Generate videos using Google's Veo model through LiteLLM's pass through endpoints. Quick Start LiteLLM allows you to use Google AI Stu..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/veo_video_generation.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/veo_video_generation.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/veo_video_generation.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/veo_video_generation.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
