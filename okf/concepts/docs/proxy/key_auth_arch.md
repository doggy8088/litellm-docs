...
title: "Key Auth Arch"
description: "How Key Based Auth Works Explanation of how the proxy resolves what a virtual key can call. Focus: how the models field is evaluated when a key has a team id versus when it does..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/key_auth_arch.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/key_auth_arch.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/key_auth_arch.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/key_auth_arch.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
