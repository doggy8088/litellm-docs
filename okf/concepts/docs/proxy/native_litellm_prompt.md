...
title: "Native Litellm Prompt"
description: "LiteLLM Prompt Management (GitOps) Store prompts as .prompt files in your repository and use them directly with LiteLLM. No external services required. Supported Integrations Fi..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/native_litellm_prompt.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/native_litellm_prompt.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/native_litellm_prompt.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/native_litellm_prompt.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
