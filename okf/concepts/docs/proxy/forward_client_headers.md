...
description: "Forward Client Headers to LLM API Control which model groups can forward client headers to the underlying LLM provider APIs. Overview By default, LiteLLM does not forward client..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/forward_client_headers.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/forward_client_headers.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/forward_client_headers.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/forward_client_headers.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
