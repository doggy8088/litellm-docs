...
title: "Multi Region"
description: "Multi Region Deployment Run LiteLLM proxy instances in multiple regions of the same cloud provider, all connected to one shared PostgreSQL database. Clients get routed to the ne..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/multi_region.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/multi_region.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/multi_region.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/multi_region.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
