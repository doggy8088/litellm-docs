...
title: "Cli"
description: "CLI Arguments This page documents all command line interface (CLI) arguments available for the LiteLLM proxy server. Server Configuration host Default: '0.0.0.0' The host for th..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/cli.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/cli.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/cli.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/cli.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
