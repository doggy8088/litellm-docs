...
description: "User Onboarding Guide A step by step guide to help admins onboard users to your LiteLLM proxy instance and help users get started with their API key. For Administrators Step 1:..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/user_onboarding.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/user_onboarding.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/user_onboarding.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/user_onboarding.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
