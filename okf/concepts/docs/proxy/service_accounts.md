...
description: "Service Accounts Use this if you want to create Virtual Keys that are not owned by a specific user but instead created for production projects Why use a service account key? Pre..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/service_accounts.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/service_accounts.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/service_accounts.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/service_accounts.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
