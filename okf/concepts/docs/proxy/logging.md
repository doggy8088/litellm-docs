...
title: "Logging"
description: "Logging Log Proxy input, output, and exceptions using: Langfuse OpenTelemetry GCS, s3, Azure (Blob) Buckets AWS SQS Lunary MLflow Deepeval Custom Callbacks Custom code and API e..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/logging.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy/logging.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy/logging.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy/logging.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
