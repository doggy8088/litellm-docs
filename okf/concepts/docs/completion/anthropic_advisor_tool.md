...
title: "Anthropic Advisor Tool"
description: "Advisor Tool Pair a faster executor model with a higher intelligence advisor model that provides strategic guidance mid generation. The advisor tool lets a fast, lower cost exec..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/anthropic_advisor_tool.md"
tags: ["docs","documentation-page"]
source_path: "docs/completion/anthropic_advisor_tool.md"
source_area: "docs"
...
This concept mirrors [`docs/completion/anthropic_advisor_tool.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/anthropic_advisor_tool.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
