...
description: "Prompt Formatting LiteLLM automatically translates the OpenAI ChatCompletions prompt format, to other models. You can control this by setting a custom prompt template for a mode..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/prompt_formatting.md"
tags: ["docs","documentation-page"]
source_path: "docs/completion/prompt_formatting.md"
source_area: "docs"
...
This concept mirrors [`docs/completion/prompt_formatting.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/prompt_formatting.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
