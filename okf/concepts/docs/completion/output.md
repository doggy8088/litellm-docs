...
title: "Output"
description: "Output Format Here's the exact json output and type you can expect from all litellm completion calls for all models You can access the response as a dictionary or as a class obj..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/output.md"
tags: ["docs","documentation-page"]
source_path: "docs/completion/output.md"
source_area: "docs"
...
This concept mirrors [`docs/completion/output.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/output.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
