...
title: "Usage"
description: "Usage LiteLLM returns the OpenAI compatible usage object across all providers. Quick Start Note: LiteLLM supports endpoint bridging—if a model does not natively support a reques..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/usage.md"
tags: ["docs","documentation-page"]
source_path: "docs/completion/usage.md"
source_area: "docs"
...
This concept mirrors [`docs/completion/usage.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/usage.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
