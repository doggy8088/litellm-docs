...
description: "Using PDF Input How to send / receive pdf's (other document types) to a /chat/completions endpoint Works for: Vertex AI models (Gemini + Anthropic) Bedrock Models Anthropic API..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/document_understanding.md"
tags: ["docs","documentation-page"]
source_path: "docs/completion/document_understanding.md"
source_area: "docs"
...
This concept mirrors [`docs/completion/document_understanding.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/document_understanding.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
