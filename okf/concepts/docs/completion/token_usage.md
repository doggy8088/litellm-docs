...
title: "Token Usage"
description: "Completion Token Usage & Cost By default LiteLLM returns token usage in all completion requests (See here) LiteLLM returns response cost in all calls. LiteLLM also exposes some..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/token_usage.md"
tags: ["docs","documentation-page"]
source_path: "docs/completion/token_usage.md"
source_area: "docs"
...
This concept mirrors [`docs/completion/token_usage.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/token_usage.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
