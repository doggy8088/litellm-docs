...
title: "Vision"
description: "Using Vision Models Quick Start Example passing images to a model 1. Define vision models on config.yaml 2. Run proxy server 3. Test it using the OpenAI Python SDK Checking if a..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/vision.md"
tags: ["docs","documentation-page"]
source_path: "docs/completion/vision.md"
source_area: "docs"
...
This concept mirrors [`docs/completion/vision.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/vision.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
