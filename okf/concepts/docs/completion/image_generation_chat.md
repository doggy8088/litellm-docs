...
description: "Image Generation in Chat Completions, Responses API This guide covers how to generate images when using the chat/completions . Note if you want this on Responses API please file..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/image_generation_chat.md"
tags: ["docs","documentation-page"]
source_path: "docs/completion/image_generation_chat.md"
source_area: "docs"
...
This concept mirrors [`docs/completion/image_generation_chat.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/image_generation_chat.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
