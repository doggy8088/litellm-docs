...
description: "Message Sanitization for Tool Calling for anthropic models Automatically fix common message formatting issues when using tool calling with modify params=True LiteLLM can automat..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/message_sanitization.md"
tags: ["docs","documentation-page"]
source_path: "docs/completion/message_sanitization.md"
source_area: "docs"
...
This concept mirrors [`docs/completion/message_sanitization.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/message_sanitization.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
