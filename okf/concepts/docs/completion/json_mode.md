...
title: "Json Mode"
description: "Structured Outputs (JSON Mode) Quick Start Check Model Support 1. Check if model supports response format Call litellm.get supported openai params to check if a model/provider s..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/json_mode.md"
tags: ["docs","documentation-page"]
source_path: "docs/completion/json_mode.md"
source_area: "docs"
...
This concept mirrors [`docs/completion/json_mode.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/completion/json_mode.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
