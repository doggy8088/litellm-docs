...
title: "A2a"
description: "Agent Gateway (A2A Protocol) Overview Add A2A Agents on LiteLLM AI Gateway, Invoke agents in A2A Protocol, track request/response logs in LiteLLM Logs. Manage which Teams, Keys..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/a2a.md"
tags: ["docs","documentation-page"]
source_path: "docs/a2a.md"
source_area: "docs"
...
This concept mirrors [`docs/a2a.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/a2a.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
