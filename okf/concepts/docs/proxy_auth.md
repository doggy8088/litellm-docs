...
title: "Proxy Auth"
description: "SDK Proxy Authentication (OAuth2/JWT Auto Refresh) Automatically obtain and refresh OAuth2/JWT tokens when using the LiteLLM Python SDK with a LiteLLM Proxy that requires JWT au..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy_auth.md"
tags: ["docs","documentation-page"]
source_path: "docs/proxy_auth.md"
source_area: "docs"
...
This concept mirrors [`docs/proxy_auth.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/proxy_auth.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
