...
title: "Mcp Aws Sigv4"
description: "MCP AWS SigV4 Auth Use AWS SigV4 authentication to connect LiteLLM to MCP servers hosted on AWS Bedrock AgentCore. Why SigV4? AWS services authenticate requests using Signature..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_aws_sigv4.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_aws_sigv4.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_aws_sigv4.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_aws_sigv4.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
