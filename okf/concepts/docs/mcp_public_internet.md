...
title: "Mcp Public Internet"
description: "Exposing MCPs on the Public Internet Control which MCP servers are visible to external callers (e.g., ChatGPT, Claude Desktop) vs. internal only callers. This is useful when you..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_public_internet.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_public_internet.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_public_internet.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_public_internet.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
