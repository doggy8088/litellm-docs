...
title: "Mcp Cost"
description: "MCP Cost Tracking LiteLLM provides two ways to track costs for MCP tool calls: | Method | When to Use | What It Does | | | | | | Config based Cost Tracking | Simple cost trackin..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_cost.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_cost.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_cost.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_cost.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
