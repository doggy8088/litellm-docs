...
title: "Mcp Openapi"
description: "MCP from OpenAPI Specs LiteLLM can convert any OpenAPI/Swagger spec into an MCP server — no custom MCP server code required. Step 1 — Add the MCP Server Add your OpenAPI based s..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_openapi.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_openapi.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_openapi.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_openapi.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
