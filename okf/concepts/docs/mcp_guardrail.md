...
title: "Mcp Guardrail"
description: "MCP Guardrails LiteLLM supports applying guardrails to MCP tool calls to ensure security and compliance. You can configure guardrails to run before or during MCP calls to valida..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_guardrail.md"
tags: ["docs","documentation-page"]
source_path: "docs/mcp_guardrail.md"
source_area: "docs"
...
This concept mirrors [`docs/mcp_guardrail.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/mcp_guardrail.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
