...
description: "/vector stores/\\{vector store id\\}/files Vector store files represent the individual files that live inside a vector store. | Feature | Supported | | | | | Logging | ✅ (full req..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/vector_store_files.md"
tags: ["docs","documentation-page"]
source_path: "docs/vector_store_files.md"
source_area: "docs"
...
This concept mirrors [`docs/vector_store_files.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/vector_store_files.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
