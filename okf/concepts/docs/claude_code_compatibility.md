...
description: "Claude Code × LiteLLM compatibility matrix This table is regenerated daily by an automated populator that runs the Claude Code CLI against the latest stable LiteLLM proxy across..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/claude_code_compatibility.md"
tags: ["docs","documentation-page"]
source_path: "docs/claude_code_compatibility.md"
source_area: "docs"
...
This concept mirrors [`docs/claude_code_compatibility.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/claude_code_compatibility.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
