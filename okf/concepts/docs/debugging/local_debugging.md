...
description: "Local Debugging There's 2 ways to do local debugging litellm. turn on debug() and by passing in a custom function completion(...logger fn= ) . Warning: Make sure to not use turn..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/debugging/local_debugging.md"
tags: ["docs","documentation-page"]
source_path: "docs/debugging/local_debugging.md"
source_area: "docs"
...
This concept mirrors [`docs/debugging/local_debugging.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/debugging/local_debugging.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
