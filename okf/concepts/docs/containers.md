...
title: "Containers"
description: "/containers Manage OpenAI code interpreter containers (sessions) for executing code in isolated environments. :::tip Looking for how to use Code Interpreter? See the Code Interp..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/containers.md"
tags: ["docs","documentation-page"]
source_path: "docs/containers.md"
source_area: "docs"
...
This concept mirrors [`docs/containers.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/containers.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
