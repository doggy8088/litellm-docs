...
description: "Call any LiteLLM model in your custom format Use this to call any LiteLLM supported .completion() model, in your custom format. Useful if you have a custom API and want to suppo..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/extras/creating_adapters.md"
tags: ["docs","documentation-page"]
source_path: "docs/extras/creating_adapters.md"
source_area: "docs"
...
This concept mirrors [`docs/extras/creating_adapters.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/extras/creating_adapters.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
