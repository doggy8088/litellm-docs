...
title: "A2a Iteration Budgets"
description: "Agent Iteration Budgets Control runaway costs from agentic loops with per session iteration and budget caps. Overview When agents run agentic loops, they can make unbounded LLM..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/a2a_iteration_budgets.md"
tags: ["docs","documentation-page"]
source_path: "docs/a2a_iteration_budgets.md"
source_area: "docs"
...
This concept mirrors [`docs/a2a_iteration_budgets.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/a2a_iteration_budgets.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
