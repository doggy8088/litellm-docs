...
description: "Adding OpenAI Compatible Providers For simple OpenAI compatible providers (like Hyperbolic, Nscale, etc.), you can add support by editing a single JSON file. Quick Start 1. Edit..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/contributing/adding_openai_compatible_providers.md"
tags: ["docs","documentation-page"]
source_path: "docs/contributing/adding_openai_compatible_providers.md"
source_area: "docs"
...
This concept mirrors [`docs/contributing/adding_openai_compatible_providers.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/contributing/adding_openai_compatible_providers.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
