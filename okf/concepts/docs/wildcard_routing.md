...
description: "Provider specific Wildcard routing Proxy all models from a provider Use this if you want to proxy all models from a specific provider without defining them on the config.yaml St..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/wildcard_routing.md"
tags: ["docs","documentation-page"]
source_path: "docs/wildcard_routing.md"
source_area: "docs"
...
This concept mirrors [`docs/wildcard_routing.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/wildcard_routing.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
