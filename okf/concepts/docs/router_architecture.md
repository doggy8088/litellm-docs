...
description: "Router Architecture (Fallbacks / Retries) High Level architecture Request Flow 1. User Sends Request : The process begins when a user sends a request to the LiteLLM Router endpo..."
resource: "https://github.com/BerriAI/litellm-docs/blob/main/docs/router_architecture.md"
tags: ["docs","documentation-page"]
source_path: "docs/router_architecture.md"
source_area: "docs"
...
This concept mirrors [`docs/router_architecture.md`](https://github.com/BerriAI/litellm-docs/blob/main/docs/router_architecture.md) from Git revision `038c9caf294fea449d24d6a787f9eaf7e3ca882f`.
