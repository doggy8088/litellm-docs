...
One proxy can serve many tenants and send each tenant's traces only to that tenant's own backend, without sharing credentials between teams.

See the full guide: [Multi-Tenant Trace Destinations](./multi_tenant_tracing.md).
